...
var Stylified = (_temp = _class = function (_Component) {
  ...
  function Stylified(props, context) {
    _classCallCheck(this, Stylified);
  ...
  _createClass(Stylified, [{
    ...
    value: function getStyle() {
      ...
      componentTheme = masterTheme[this.componentName] || this.props.defaultStyle,
      ...
      // based on props
      //
      if (typeof this.props.makeStyles === 'function') {
        styleObj = this.props.makeStyles({
    ...
    value: function render() {
      var styleProperties = this.getStyle(),
          ...
          defaultStyle = otherProps.defaultStyle,
          makeStyles = otherProps.makeStyles,
          style = otherProps.style,
          passThroughProps = _objectWithoutProperties(otherProps, ['name', 'defaultStyle', 'makeStyles', 'style']),
